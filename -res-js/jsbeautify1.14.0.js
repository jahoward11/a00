!function() {
    ...
    !function() {
        "use strict";
        var n = [function(t, e, u) {
            var n = u(1).Beautifier
              , i = u(5).Options;
        ...
        , function(t, e, u) {
            ...
            T.prototype.create_flags = function(t, e) {
                var u = 0;
                return t && (u = t.indentation_level,
                !this._output.just_added_newline() && t.line_indent_level > u && (u = t.line_indent_level)),
                {
                    mode: e,
                    parent: t,
                    last_token: t ? t.last_token : new i(p.START_BLOCK,""),
            ...
            T.prototype._reset = function(t) {
                ...
                this._output = new n(this._options,e),
                this._output.raw = this._options.test_output_raw,
                this._flag_store = [],
                this.set_mode(g);
                e = new s(t,this._options);
                return this._tokens = e.tokenize(),
                t
            }
            ,
            ...
            T.prototype.handle_token = function(t, e) {
                t.type === p.START_EXPR ? this.handle_start_expr(t) : t.type === p.END_EXPR ? this.handle_end_expr(t) : t.type === p.START_BLOCK ? this.handle_start_block(t) : t.type === p.END_BLOCK ? this.handle_end_block(t) : t.type === p.WORD || t.type === p.RESERVED ? this.handle_word(t) : t.type === p.SEMICOLON ? this.handle_semicolon(t) : t.type === p.STRING ? this.handle_string(t) : t.type === p.EQUALS ? this.handle_equals(t) : t.type === p.OPERATOR ? this.handle_operator(t) : t.type === p.COMMA ? this.handle_comma(t) : t.type === p.BLOCK_COMMENT ? this.handle_block_comment(t, e) : t.type === p.COMMENT ? this.handle_comment(t, e) : t.type === p.DOT ? this.handle_dot(t) : t.type === p.EOF ? this.handle_eof(t) : (t.type,
                p.UNKNOWN,
            ...
            T.prototype.handle_whitespace_and_comments = function(t, e) {
                ...
                if (n)
                    for (var _ = 0; _ < u; _ += 1)
                        this.print_newline(0 < _, e);
                else if (this._options.max_preserve_newlines && u > this._options.max_preserve_newlines && (u = this._options.max_preserve_newlines),
                this._options.preserve_newlines && 1 < u) {
            ...
            T.prototype.allow_wrap_or_preserved_newline = function(t, e) {
                e = void 0 !== e && e,
                this._output.just_added_newline() || (e = this._options.preserve_newlines && t.newlines || e,
                (l(this._flags.last_token.text, h) || l(t.text, h)) && (t = l(this._flags.last_token.text, h) && l(this._options.operator_position, b) || l(t.text, h),
                e = e && t),
            ...
            T.prototype.print_newline = function(t, e) {
                if (!e && ";" !== this._flags.last_token.text && "," !== this._flags.last_token.text && "=" !== this._flags.last_token.text && (this._flags.last_token.type !== p.OPERATOR || "--" === this._flags.last_token.text || "++" === this._flags.last_token.text))
                    for (var u = this._tokens.peek(); !(this._flags.mode !== m || this._flags.if_block && a(u, "else") || this._flags.do_block); )
                        this.restore_mode();
                this._output.add_new_line(t) && (this._flags.multiline_frame = !0)
            }
            ,
            T.prototype.print_token_line_indentation = function(t) {
                this._output.just_added_newline() && (this._options.keep_array_indentation && t.newlines && ("[" === t.text || R(this._flags.mode)) ? (this._output.current_line.set_indent(-1),
            ...
            T.prototype.print_token = function(t) {
                var e;
                this._output.raw ? this._output.add_raw_token(t) : (this._options.comma_first && t.previous && t.previous.type === p.COMMA && this._output.just_added_newline() && "," === this._output.previous_line.last() && (e = this._output.previous_line.pop(),
            ...
            T.prototype.handle_start_expr = function(t) {
                ...
                if ("[" === t.text) {
                    if (this._flags.last_token.type === p.WORD || ")" === this._flags.last_token.text)
                        return f(this._flags.last_token, r) && (this._output.space_before_token = !0),
                        this.print_token(t),
                        this.set_mode(n),
                        this.indent(),
                    ...
                    this._flags.last_token.type === p.RESERVED ? "for" === this._flags.last_token.text ? (this._output.space_before_token = this._options.space_before_conditional,
                    n = y) : l(this._flags.last_token.text, ["if", "while", "switch"]) ? (this._output.space_before_token = this._options.space_before_conditional,
                    n = x) : l(this._flags.last_word, ["await", "async"]) ? this._output.space_before_token = !0 : "import" === this._flags.last_token.text && "" === t.whitespace_before ? this._output.space_before_token = !1 : !l(this._flags.last_token.text, r) && "catch" !== this._flags.last_token.text || (this._output.space_before_token = !0) : this._flags.last_token.type === p.EQUALS || this._flags.last_token.type === p.OPERATOR ? this.start_of_object_property() || this.allow_wrap_or_preserved_newline(t) : this._flags.last_token.type === p.WORD ? (this._output.space_before_token = !1,
                    e = this._tokens.peek(-3),
                    this._options.space_after_named_function && e && (u = this._tokens.peek(-4),
                    f(e, ["async", "function"]) || "*" === e.text && f(u, ["async", "function"]) ? this._output.space_before_token = !0 : this._flags.mode === k && ("{" !== e.text && "," !== e.text && ("*" !== e.text || "{" !== u.text && "," !== u.text) || (this._output.space_before_token = !0)))) : this.allow_wrap_or_preserved_newline(t),
                    (this._flags.last_token.type === p.RESERVED && ("function" === this._flags.last_word || "typeof" === this._flags.last_word) || "*" === this._flags.last_token.text && (l(this._last_last_text, ["function", "yield"]) || this._flags.mode === k && l(this._last_last_text, ["{", ","]))) && (this._output.space_before_token = this._options.space_after_anon_function);
                ";" === this._flags.last_token.text || this._flags.last_token.type === p.START_BLOCK ? this.print_newline() : this._flags.last_token.type !== p.END_EXPR && this._flags.last_token.type !== p.START_EXPR && this._flags.last_token.type !== p.END_BLOCK && "." !== this._flags.last_token.text && this._flags.last_token.type !== p.COMMA || this.allow_wrap_or_preserved_newline(t, t.newlines),
                this.print_token(t),
                this.set_mode(n),
            ...
            T.prototype.handle_end_expr = function(t) {
                ...
                this._options.space_in_paren && (this._flags.last_token.type !== p.START_EXPR || this._options.space_in_empty_paren ? this._output.space_before_token = !0 : (this._output.trim(),
                this._output.space_before_token = !1)),
                this.deindent(),
                this.print_token(t),
                this.restore_mode(),
                E(this._output, this._previous_flags),
                this._flags.do_while && this._previous_flags.mode === x && (this._previous_flags.mode = v,
            ...
            T.prototype.handle_start_block = function(t) {
                ...
                "switch" === this._flags.last_word && this._flags.last_token.type === p.END_EXPR ? (this.set_mode(g),
                this._flags.in_case_statement = !0) : this._flags.case_body ? this.set_mode(g) : u && (l(u.text, [":", ","]) && l(e.type, [p.STRING, p.WORD, p.RESERVED]) || l(e.text, ["get", "set", "..."]) && l(u.type, [p.WORD, p.RESERVED])) ? l(this._last_last_text, ["class", "interface"]) ? this.set_mode(g) : this.set_mode(k) : (this._flags.last_token.type !== p.OPERATOR || "=>" !== this._flags.last_token.text) && (l(this._flags.last_token.type, [p.EQUALS, p.START_EXPR, p.COMMA, p.OPERATOR]) || f(this._flags.last_token, ["return", "throw", "import", "default"])) ? this.set_mode(k) : this.set_mode(g);
                u = !e.comments_before && "}" === e.text,
                e = u && "function" === this._flags.last_word && this._flags.last_token.type === p.END_EXPR;
                if (this._options.brace_preserve_inline) {
                    var n = 0
                      , i = null;
                    this._flags.inline_frame = !0;
                    do {
                        if ((i = this._tokens.peek((n += 1) - 1)).newlines) {
                            this._flags.inline_frame = !1;
                            break
                        }
                    } while (i.type !== p.EOF && (i.type !== p.END_BLOCK || i.opened !== t))
                }
                ...
                (this._flags.last_token.type === p.COMMA || this._flags.last_token.type === p.START_EXPR && this._flags.inline_frame) && (this.allow_wrap_or_preserved_newline(t),
                this._previous_flags.multiline_frame = this._previous_flags.multiline_frame || this._flags.multiline_frame,
                this._flags.multiline_frame = !1)),
                this._flags.last_token.type !== p.OPERATOR && this._flags.last_token.type !== p.START_EXPR && (this._flags.last_token.type !== p.START_BLOCK || this._flags.inline_frame ? this._output.space_before_token = !0 : this.print_newline())),
                this.print_token(t),
                this.indent(),
                u || this._options.brace_preserve_inline && this._flags.inline_frame || this.print_newline()
            }
            ,
            T.prototype.handle_end_block = function(t) {
                ...
                this._flags.inline_frame && !e ? this._output.space_before_token = !0 : "expand" === this._options.brace_style ? e || this.print_newline() : e || (R(this._flags.mode) && this._options.keep_array_indentation ? (this._options.keep_array_indentation = !1,
                this.print_newline(),
            ...
            T.prototype.handle_word = function(t) {
                if (t.type === p.RESERVED && (l(t.text, ["set", "get"]) && this._flags.mode !== k || "import" === t.text && "(" === this._tokens.peek().text || l(t.text, ["as", "from"]) && !this._flags.import_block || this._flags.mode === k && ":" === this._tokens.peek().text) && (t.type = p.WORD),
                this.start_of_statement(t) ? f(this._flags.last_token, ["var", "let", "const"]) && t.type === p.WORD && (this._flags.declaration_statement = !0) : !t.newlines || O(this._flags.mode) || this._flags.last_token.type === p.OPERATOR && "--" !== this._flags.last_token.text && "++" !== this._flags.last_token.text || this._flags.last_token.type === p.EQUALS || !this._options.preserve_newlines && f(this._flags.last_token, ["var", "let", "const", "set", "get"]) ? this.handle_whitespace_and_comments(t) : (this.handle_whitespace_and_comments(t),
                this.print_newline()),
                ...
                if (this._flags.in_case_statement && f(t, ["case", "default"]))
                    ...
                    this._flags.last_token.type !== p.END_BLOCK && (this._flags.case_body || this._options.jslint_happy) && this.deindent(),
                    this._flags.case_body = !1,
                    this.print_token(t),
                    void (this._flags.in_case = !0);
                if (this._flags.last_token.type !== p.COMMA && this._flags.last_token.type !== p.START_EXPR && this._flags.last_token.type !== p.EQUALS && this._flags.last_token.type !== p.OPERATOR || this.start_of_object_property() || this.allow_wrap_or_preserved_newline(t),
                a(t, "function"))
                    return (l(this._flags.last_token.text, ["}", ";"]) || this._output.just_added_newline() && !l(this._flags.last_token.text, ["(", "[", "{", ":", "=", ","]) && this._flags.last_token.type !== p.OPERATOR) && (this._output.just_added_blankline() || t.comments_before || (this.print_newline(),
                    this.print_newline(!0))),
                    this._flags.last_token.type === p.RESERVED || this._flags.last_token.type === p.WORD ? f(this._flags.last_token, ["get", "set", "new", "export"]) || f(this._flags.last_token, A) || a(this._flags.last_token, "default") && "export" === this._last_last_text || "declare" === this._flags.last_token.text ? this._output.space_before_token = !0 : this.print_newline() : this._flags.last_token.type === p.OPERATOR || "=" === this._flags.last_token.text ? this._output.space_before_token = !0 : !this._flags.multiline_frame && (O(this._flags.mode) || R(this._flags.mode)) || this.print_newline(),
                    this.print_token(t),
                    void (this._flags.last_word = t.text);
                var e = "NONE";
                this._flags.last_token.type === p.END_BLOCK ? this._previous_flags.inline_frame ? e = "SPACE" : !f(t, ["else", "catch", "finally", "from"]) || "expand" === this._options.brace_style || "end-expand" === this._options.brace_style || "none" === this._options.brace_style && t.newlines ? e = "NEWLINE" : (e = "SPACE",
                this._output.space_before_token = !0) : this._flags.last_token.type === p.SEMICOLON && this._flags.mode === g ? e = "NEWLINE" : this._flags.last_token.type === p.SEMICOLON && O(this._flags.mode) ? e = "SPACE" : this._flags.last_token.type === p.STRING ? e = "NEWLINE" : this._flags.last_token.type === p.RESERVED || this._flags.last_token.type === p.WORD || "*" === this._flags.last_token.text && (l(this._last_last_text, ["function", "yield"]) || this._flags.mode === k && l(this._last_last_text, ["{", ","])) ? e = "SPACE" : this._flags.last_token.type === p.START_BLOCK ? e = this._flags.inline_frame ? "SPACE" : "NEWLINE" : this._flags.last_token.type === p.END_EXPR && (this._output.space_before_token = !0,
                e = "NEWLINE"),
                ...
                f(t, ["else", "catch", "finally"]) ? (this._flags.last_token.type !== p.END_BLOCK || this._previous_flags.mode !== g || "expand" === this._options.brace_style || "end-expand" === this._options.brace_style || "none" === this._options.brace_style && t.newlines) && !this._flags.inline_frame ? this.print_newline() : (this._output.trim(!0),
                "}" !== this._output.current_line.last() && this.print_newline(),
                this._output.space_before_token = !0) : "NEWLINE" === e ? f(this._flags.last_token, c) || "declare" === this._flags.last_token.text && f(t, ["var", "let", "const"]) ? this._output.space_before_token = !0 : this._flags.last_token.type !== p.END_EXPR ? this._flags.last_token.type === p.START_EXPR && f(t, ["var", "let", "const"]) || ":" === this._flags.last_token.text || (a(t, "if") && a(t.previous, "else") ? this._output.space_before_token = !0 : this.print_newline()) : f(t, r) && ")" !== this._flags.last_token.text && this.print_newline() : this._flags.multiline_frame && R(this._flags.mode) && "," === this._flags.last_token.text && "}" === this._last_last_text ? this.print_newline() : "SPACE" === e && (this._output.space_before_token = !0),
                ...
                t.type === p.RESERVED && ("do" === t.text ? this._flags.do_block = !0 : "if" === t.text ? this._flags.if_block = !0 : "import" === t.text ? this._flags.import_block = !0 : this._flags.import_block && a(t, "from") && (this._flags.import_block = !1))
            }
            ,
            T.prototype.handle_semicolon = function(t) {
                ...
                for (var e = this._tokens.peek(); !(this._flags.mode !== m || this._flags.if_block && a(e, "else") || this._flags.do_block); )
                    this.restore_mode();
            ...
            T.prototype.handle_string = function(t) {
                t.text.startsWith("`") && 0 === t.newlines && "" === t.whitespace_before && (")" === t.previous.text || this._flags.last_token.type === p.WORD) || (this.start_of_statement(t) ? this._output.space_before_token = !0 : (this.handle_whitespace_and_comments(t),
                this._flags.last_token.type === p.RESERVED || this._flags.last_token.type === p.WORD || this._flags.inline_frame ? this._output.space_before_token = !0 : this._flags.last_token.type === p.COMMA || this._flags.last_token.type === p.START_EXPR || this._flags.last_token.type === p.EQUALS || this._flags.last_token.type === p.OPERATOR ? this.start_of_object_property() || this.allow_wrap_or_preserved_newline(t) : !t.text.startsWith("`") || this._flags.last_token.type !== p.END_EXPR || "]" !== t.previous.text && ")" !== t.previous.text || 0 !== t.newlines ? this.print_newline() : this._output.space_before_token = !0)),
                this.print_token(t)
            }
            ,
            ...
            T.prototype.handle_comma = function(t) {
                ...
                this.print_token(t),
                this._output.space_before_token = !0,
                this._flags.declaration_statement ? (O(this._flags.parent.mode) && (this._flags.declaration_assignment = !1),
                this._flags.declaration_assignment ? (this._flags.declaration_assignment = !1,
                this.print_newline(!1, !0)) : this._options.comma_first && this.allow_wrap_or_preserved_newline(t)) : this._flags.mode === k || this._flags.mode === m && this._flags.parent.mode === k ? (this._flags.mode === m && this.restore_mode(),
            ...
            T.prototype.handle_operator = function(t) {
                var e = "*" === t.text && (f(this._flags.last_token, ["function", "yield"]) || l(this._flags.last_token.type, [p.START_BLOCK, p.COMMA, p.END_BLOCK, p.SEMICOLON]))
                  , u = l(t.text, ["-", "+"]) && (l(this._flags.last_token.type, [p.START_BLOCK, p.START_EXPR, p.EQUALS, p.OPERATOR]) || l(this._flags.last_token.text, r) || "," === this._flags.last_token.text);
                if (this.start_of_statement(t) || this.handle_whitespace_and_comments(t, !e),
                f(this._flags.last_token, c))
                    return this._output.space_before_token = !0,
                    void this.print_token(t);
                if ("*" !== t.text || this._flags.last_token.type !== p.DOT)
                    if ("::" !== t.text) {
                        if (this._flags.last_token.type === p.OPERATOR && l(this._options.operator_position, b) && this.allow_wrap_or_preserved_newline(t),
                        ":" === t.text && this._flags.in_case)
                            return this.print_token(t),
                            this._flags.in_case = !1,
                            this._flags.case_body = !0,
                            void (this._tokens.peek().type !== p.START_BLOCK ? (this.indent(),
                            this.print_newline()) : this._output.space_before_token = !0);
                        var n = !0
                          , i = !0
                          , _ = !1;
                        if (":" === t.text ? 0 === this._flags.ternary_depth ? n = !1 : (--this._flags.ternary_depth,
                        _ = !0) : "?" === t.text && (this._flags.ternary_depth += 1),
                        !u && !e && this._options.preserve_newlines && l(t.text, h)) {
                            var s = ":" === t.text
                              , a = s && _
                              , o = s && !_;
                            switch (this._options.operator_position) {
                            case d.before_newline:
                                return this._output.space_before_token = !o,
                                this.print_token(t),
                                s && !a || this.allow_wrap_or_preserved_newline(t),
                            ...
                            case d.preserve_newline:
                                return o || this.allow_wrap_or_preserved_newline(t),
                        ...
                        e ? (this.allow_wrap_or_preserved_newline(t),
                        n = !1,
                        i = (e = this._tokens.peek()) && l(e.type, [p.WORD, p.RESERVED])) : "..." === t.text ? (this.allow_wrap_or_preserved_newline(t),
                        n = this._flags.last_token.type === p.START_BLOCK,
                        i = !1) : (l(t.text, ["--", "++", "!", "~"]) || u) && (this._flags.last_token.type !== p.COMMA && this._flags.last_token.type !== p.START_EXPR || this.allow_wrap_or_preserved_newline(t),
                        i = n = !1,
                        !t.newlines || "--" !== t.text && "++" !== t.text || this.print_newline(!1, !0),
                        ";" === this._flags.last_token.text && O(this._flags.mode) && (n = !0),
                        this._flags.last_token.type === p.RESERVED ? n = !0 : this._flags.last_token.type === p.END_EXPR ? n = !("]" === this._flags.last_token.text && ("--" === t.text || "++" === t.text)) : this._flags.last_token.type === p.OPERATOR && (n = l(t.text, ["--", "-", "++", "+"]) && l(this._flags.last_token.text, ["--", "-", "++", "+"]),
                        l(t.text, ["+", "-"]) && l(this._flags.last_token.text, ["--", "++"]) && (i = !0)),
                        (this._flags.mode !== g || this._flags.inline_frame) && this._flags.mode !== m || "{" !== this._flags.last_token.text && ";" !== this._flags.last_token.text || this.print_newline()),
            ...
            T.prototype.handle_block_comment = function(t, e) {
                ...
                void this.print_newline(!1, !0)) : void (o.newline.test(t.text) || t.newlines ? this.print_block_commment(t, e) : (this._output.space_before_token = !0,
                this.print_token(t),
                this._output.space_before_token = !0))
            }
            ,
            T.prototype.print_block_commment = function(t, e) {
                var u, n, i, _ = function(t) {
                    for (var e = [], u = (t = t.replace(o.allLineBreaks, "\n")).indexOf("\n"); -1 !== u; )
                        e.push(t.substring(0, u)),
                ...
                this.print_token_line_indentation(t),
                this._output.add_token(_[0]),
                this.print_newline(!1, e),
                1 < _.length) {
                    for (n = function(t, e) {
                        for (var u = 0; u < t.length; u++)
                            if (t[u].trim().charAt(0) !== e)
                                return !1;
                        return !0
                    }(_ = _.slice(1), "*"),
                    i = function(t, e) {
                        for (var u, n = 0, i = t.length; n < i; n++)
                            if ((u = t[n]) && 0 !== u.indexOf(e))
                                return !1;
                        return !0
                    }(_, s),
                    n && (this._flags.alignment = 1),
                    u = 0; u < _.length; u++)
                        n ? (this.print_token_line_indentation(t),
                        this._output.add_token(_[u].replace(/^\s+/g, ""))) : i && _[u] ? (this.print_token_line_indentation(t),
                        this._output.add_token(_[u].substring(a))) : (this._output.current_line.set_indent(-1),
                        this._output.add_token(_[u])),
                        this.print_newline(!1, e);
        ...
        , function(t) {
            ...
            i.prototype._remove_indent = function() {
                0 < this.__indent_count && (--this.__indent_count,
            ...
            ,
            u.prototype.get_indent_size = function(t, e) {
            ...
            ,
            u.prototype.get_indent_string = function(t, e) {
            ...
            e.prototype.set_indent = function(t, e) {
                return this.next_line.set_indent(t = t || 0, e = e || 0),
                1 < this.__lines.length ? (this.current_line.set_indent(t, e),
            ...
            e.prototype.trim = function(t) {
                for (t = void 0 !== t && t,
                this.current_line.trim(); t && 1 < this.__lines.length && this.current_line.is_empty(); )
                    this.__lines.pop(),
            ...
            e.prototype.ensure_empty_line_above = function(t, e) {
                for (var u = this.__lines.length - 2; 0 <= u; ) {
                    var n = this.__lines[u];
                    if (n.is_empty())
                        break;
                    if (0 !== n.item(0).indexOf(t) && n.item(-1) !== e) {
                        this.__lines.splice(u + 1, 0, new i(this)),
        ...
        , function(t) {
            t.exports.Token = function(t, e, u, n) {
                this.type = t,
                this.text = e,
        ...
        , function(t, e) {
            var u = "\\x24\\x30-\\x39\\x41-\\x5a\\x5f\\x61-\\x7a"
            ...
            e.identifierStart = new RegExp(_),
            e.identifierMatch = new RegExp("(?:\\\\u[0-9a-fA-F]{4}|[" + u + n + i + "])+");
            e.newline = /[\n\r\u2028\u2029]/,
        ...
        , function(t, e, u) {
            ...
            function _(t) {
                n.call(this, t, "js");
                t = this.raw_options.brace_style || null;
                ...
                var e = this._get_selection_list("brace_style", ["collapse", "expand", "end-expand", "none", "preserve-inline"]);
                this.brace_preserve_inline = !1,
                this.brace_style = "collapse";
                for (var u = 0; u < e.length; u++)
                    "preserve-inline" === e[u] ? this.brace_preserve_inline = !0 : this.brace_style = e[u];
        ...
        , function(t) {
            ...
            e.prototype._get_array = function(t, e) {
                ...
                e = e || [];
                return "object" == typeof t ? null !== t && "function" == typeof t.concat && (e = t.concat()) : "string" == typeof t && (e = t.split(/[^a-zA-Z0-9_\/\-]+/)),
                e
            }
            ,
            ...
            ,
            e.prototype._get_selection = function(t, e, u) {
                u = this._get_selection_list(t, e, u);
                if (1 !== u.length)
            ...
            ,
            e.prototype._get_selection_list = function(t, e, u) {
                if (!e || 0 === e.length)
                    throw new Error("Selection list cannot be empty.");
                if (u = u || [e[0]],
                !this._is_valid_selection(u, e))
                    throw new Error("Invalid Default Value!");
                u = this._get_array(t, u);
                if (!this._is_valid_selection(u, e))
        ...
        , function(t, e, u) {
            ...
            var p = {
              ...
              , u = ">>> === !== << && >= ** != == <= >> || ?? |> < / - + > : & % ? ^ | *".split(" ")
              , i = ">>>= ... >>= <<= === >>> !== **= => ^= :: /= << <= == && -= >= >> != -- += ** || ?? ++ %= &= *= |= |> = ! ? > < : / ^ - + * & % ~ |";
            i = (i = "\\?\\.(?!\\d) " + (i = i.replace(/[-[\]{}()*+?.,\\^$|#]/g, "\\$&"))).replace(/ /g, "|");
            var b, g = new RegExp(i), s = "continue,try,throw,return,var,let,const,if,switch,case,default,for,while,break,function,import,export".split(","), i = s.concat(["do", "in", "of", "else", "get", "set", "new", "catch", "finally", "typeof", "yield", "async", "await", "from", "as"]), m = new RegExp("^(?:" + i.join("|") + ")$"), i = function(t, e) {
                n.call(this, t, e),
                ...
                this.__patterns = {
                    ...
                    xml: t.matching(/[\s\S]*?<(\/?)([-a-zA-Z:0-9_.]+|{[\s\S]+?}|!\[CDATA\[[\s\S]*?\]\]|)(\s+{[\s\S]+?}|\s+[-a-zA-Z:0-9_.]+|\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{[\s\S]+?}))*\s*(\/?)\s*>/),
            ...
            (i.prototype = new n)._is_comment = function(t) {
            ...
            i.prototype._get_next_token = function(t, e) {
                ...
                var u = this._input.peek();
                return null === u ? this._create_token(p.EOF, "") : this._read_non_javascript(u) || this._read_string(u) || this._read_word(t) || this._read_singles(u) || this._read_comment(u) || this._read_regexp(u, t) || this._read_xml(u, t) || this._read_punctuation() || this._create_token(p.UNKNOWN, this._input.next())
            }
            ,
            i.prototype._read_word = function(t) {
                var e = this.__patterns.identifier.read();
                return "" !== e ? (e = e.replace(r.allLineBreaks, "\n"),
                t.type !== p.DOT && (t.type !== p.RESERVED || "set" !== t.text && "get" !== t.text) && m.test(e) ? "in" === e || "of" === e ? this._create_token(p.OPERATOR, e) : this._create_token(p.RESERVED, e) : this._create_token(p.WORD, e)) : "" !== (e = this.__patterns.number.read()) ? this._create_token(p.WORD, e) : void 0
            }
            ,
            i.prototype._read_singles = function(t) {
                var e = null;
            ...
            ,
            i.prototype._read_punctuation = function() {
            ...
            ,
            i.prototype._read_non_javascript = function(t) {
                var e = "";
                if ("#" === t) {
                    ...
                    if (this._input.hasNext() && this._input.testChar(c)) {
                        for (; u += t = this._input.next(),
                        this._input.hasNext() && "#" !== t && "=" !== t; )
                            ;
                        return "#" === t || ("[" === this._input.peek() && "]" === this._input.peek(1) ? (u += "[]",
                        this._input.next(),
                        this._input.next()) : "{" === this._input.peek() && "}" === this._input.peek(1) && (u += "{}",
                        this._input.next(),
                        this._input.next())),
            ...
            ,
            i.prototype._read_comment = function(t) {
                var e, u = null;
                return "/" === t && (e = "",
                "*" === this._input.peek(1) ? (e = this.__patterns.block_comment.read(),
                (t = l.get_directives(e)) && "start" === t.ignore && (e += l.readIgnored(this._input)),
                e = e.replace(r.allLineBreaks, "\n"),
                (u = this._create_token(p.BLOCK_COMMENT, e)).directives = t) : "/" === this._input.peek(1) && (e = this.__patterns.comment.read(),
                u = this._create_token(p.COMMENT, e))),
                u
            }
            ,
            i.prototype._read_string = function(t) {
                if ("`" !== t && "'" !== t && '"' !== t)
                    return null;
                ...
                this.has_char_escapes && this._options.unescape_strings && (e = function(t) {
                    ...
                    for (; n.hasNext(); )
                        ...
                        "\\" === n.peek()) {
                            ...
                            if (!i)
                                return t;
                            if (126 < (u = parseInt(i[1], 16)) && u <= 255 && 0 === i[0].indexOf("x"))
                                return t;
                            e += 0 <= u && u < 32 ? "\\" + i[0] : 34 === u || 39 === u || 92 === u ? "\\" + String.fromCharCode(u) : String.fromCharCode(u)
                        }
                    return e
                }(e)),
            ...
            ,
            i.prototype._allow_regexp_or_xml = function(t) {
            ...
            ,
            i.prototype._read_regexp = function(t, e) {
                if ("/" === t && this._allow_regexp_or_xml(e)) {
                    for (var u = this._input.next(), n = !1, i = !1; this._input.hasNext() && (n || i || this._input.peek() !== t) && !this._input.testChar(r.newline); )
                        u += this._input.peek(),
                        n ? n = !1 : (n = "\\" === this._input.peek(),
                        "[" === this._input.peek() ? i = !0 : "]" === this._input.peek() && (i = !1)),
                        this._input.next();
                    return this._input.peek() === t && (u += this._input.next(),
                    u += this._input.read(r.identifier)),
                    this._create_token(p.STRING, u)
                }
                return null
            }
            ,
            i.prototype._read_xml = function(t, e) {
                if (this._options.e4x && "<" === t && this._allow_regexp_or_xml(e)) {
                    var u = ""
                      , n = this.__patterns.xml.read_match();
                    if (n) {
                        for (var i = n[2].replace(/^{\s+/, "{").replace(/\s+}$/, "}"), _ = 0 === i.indexOf("{"), s = 0; n; ) {
                            var a = !!n[1]
                              , o = n[2];
                            if (!(!!n[n.length - 1] || "![CDATA[" === o.slice(0, 8)) && (o === i || _ && o.replace(/^{\s+/, "{").replace(/\s+}$/, "}")) && (a ? --s : ++s),
                            u += n[0],
                            s <= 0)
                                break;
                            n = this.__patterns.xml.read_match()
                        }
                        return n || (u += this._input.match(/[\s\S]*/g)[0]),
            ...
            ,
            i.prototype._read_string_recursive = function(t, e, u) {
                var n, i;
                ...
                for (var _ = i.read(), s = ""; this._input.hasNext(); ) {
                    ...
                    s += this._input.next()) : u && ("${" === u && "$" === s && "{" === this._input.peek() && (s += this._input.next()),
                    u === s && (s += "`" === t ? this._read_string_recursive("}", e, "`") : this._read_string_recursive("`", e, "${"),
            ...
            t.exports.TOKEN = p,
            t.exports.positionable_operators = u.slice(),
        ...
        , function(t) {
            ...
            e.prototype.peek = function(t) {
                var e = null;
                return t = t || 0,
                e = 0 <= (t += this.__position) && t < this.__input_length ? this.__input.charAt(t) : e
            }
            ,
            ...
            ,
            e.prototype.read = function(t, e, u) {
                var n, i = "";
                return t && (n = this.match(t)) && (i += n[0]),
                !e || !n && t || (i += this.readUntil(e, u)),
                i
            }
            ,
            e.prototype.readUntil = function(t, e) {
                var u, n = this.__position;
                t.lastIndex = this.__position;
                t = t.exec(this.__input);
                return t ? (n = t.index,
                e && (n += t[0].length)) : n = this.__input_length,
                u = this.__input.substring(this.__position, n),
                this.__position = n,
                u
            }
            ,
            ...
            e.prototype.get_regexp = function(t, e) {
                var u = null
                  , e = e && n ? "y" : "g";
                return "string" == typeof t && "" !== t ? u = new RegExp(t,e) : t && (u = new RegExp(t.source,e)),
                u
            }
            ,
        ...
        , function(t, e, u) {
            var n = u(8).InputScanner
              , _ = u(3).Token
              , s = u(10).TokenStream
              , i = u(11).WhitespacePattern
              , a = {
                START: "TK_START",
                RAW: "TK_RAW",
                EOF: "TK_EOF"
            ...
            u.prototype.tokenize = function() {
                ...
                this.__tokens = new s,
                this._reset();
                for (var e = new _(a.START,""), u = null, n = [], i = new s; e.type !== a.EOF; ) {
                    for (t = this._get_next_token(e, u); this._is_comment(t); )
                        i.add(t),
                        t = this._get_next_token(e, u);
                    i.isEmpty() || (t.comments_before = i,
                    i = new s),
                    t.parent = u,
                    this._is_opening(t) ? (n.push(u),
                    u = t) : u && this._is_closing(t, u) && ((t.opened = u).closed = t,
                    u = n.pop(),
                    t.parent = u),
                    (t.previous = e).next = t,
                    this.__tokens.add(t),
        ...
        , function(t, e, u) {
            ...
            (i.prototype = new n).__set_whitespace_patterns = function(t, e) {
            ...
            i.prototype.read = function() {
                ...
                return " " === e ? this.whitespace_before_token = " " : e && (t = this.__split(this._newline_regexp, e),
            ...
            i.prototype.__split = function(t, e) {
                for (var u = t.lastIndex = 0, n = [], i = t.exec(e); i; )
                    n.push(e.substring(u, i.index)),
                    u = i.index + i[0].length,
                    i = t.exec(e);
                return u < e.length ? n.push(e.substring(u, e.length)) : n.push(""),
                n
            }
            ,
        ...
        , function(t) {
            ...
            e.prototype.get_directives = function(t) {
                ...
                for (var u = this.__directive_pattern.exec(t); u; )
                    e[u[1]] = u[2],
        ...
        , function(t, e, u) {
            ...
            function _(t, e) {
                ...
                this.__patterns = {
                    ...
                    handlebars_unescaped: t.starting_with(/{{{/).until_after(/}}}/),
                    handlebars: t.starting_with(/{{/).until_after(/}}/),
                    php: t.starting_with(/<\?(?:[= ]|php)/).until_after(/\?>/),
                    erb: t.starting_with(/<%[^%]/).until_after(/[^%]%>/),
                    django: t.starting_with(/{%/).until_after(/%}/),
                    django_value: t.starting_with(/{{/).until_after(/}}/),
                    django_comment: t.starting_with(/{#/).until_after(/#}/),
                    smarty: t.starting_with(/{(?=[^}{\s\n])/).until_after(/[^\s\n]}/),
                    smarty_comment: t.starting_with(/{\*/).until_after(/\*}/),
                    smarty_literal: t.starting_with(/{literal}/).until_after(/{\/literal}/)
                }
            }
            ...
            _.prototype.read_options = function(t) {
                var e, u = this._create();
                for (e in i)
                    u._disabled[e] = -1 === t.templating.indexOf(e);
                return u._update(),
                u
            }
            ,
            ...
            _.prototype._read_template = function() {
                var t, e = "", u = this._input.peek();
                return "<" === u ? (t = this._input.peek(1),
                this._disabled.php || this._excluded.php || "?" !== t || (e = e || this.__patterns.php.read()),
                this._disabled.erb || this._excluded.erb || "%" !== t || (e = e || this.__patterns.erb.read())) : "{" === u && (this._disabled.handlebars || this._excluded.handlebars || (e = (e = (e = e || this.__patterns.handlebars_comment.read()) || this.__patterns.handlebars_unescaped.read()) || this.__patterns.handlebars.read()),
                ...
                this._disabled.smarty || this._disabled.django && this._disabled.handlebars && (e = (e = (e = e || this.__patterns.smarty_comment.read()) || this.__patterns.smarty_literal.read()) || this.__patterns.smarty.read())),
                e
            }
            ,
